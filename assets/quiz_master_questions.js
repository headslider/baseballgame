window.QUIZ_MASTER_QUESTIONS = {
  "meta": {
    "title": "野球博士チャレンジ",
    "version": "final_candidate_v46_grade_expression_cleanup",
    "created_by": "ChatGPT",
    "question_count": 252,
    "answer_index_base": 0,
    "rules": [
    ...
    "source_file": "quiz_master_questions_final_candidate_v45_sunglass_pitch_cleanup.json",
    ...
    "validation_errors": [],
    "base_file": "quiz_master_questions_final_candidate_v44_spike_stud_cleanup.json",
    ...
    "grade_expression_rule": {
      "rule": "学年を示す場合、「高学年」「低学年」だけで始めず、必ず「小学生の高学年」「小学生の低学年」のように「小学生」を先に置く。問題文だけでなく選択肢・解説も同じ表記に統一する。",
      "examples": [
        "小学生の高学年では…",
        "小学生の低学年が…"
      ],
  ...
  "questions": [
    ...
    },
    {
      ...
      "level_name": "第3問",
      "category": "JSBB学童部規定",
      "question": "小学生の高学年でよく使われる塁間距離として正しいものは（JSBB学童部規定）？",
      "choices": [
        "25m",
        "23m",
        "21m"
    ...
    },
    {
      ...
      "level_name": "第3問",
      "category": "JSBB学童部規定",
      "question": "小学生の低学年で採用されることがある塁間距離として正しいものは（JSBB学童部規定）？",
      "choices": [
        "27.43m",
        "23m",
        "21m"
    ...
    },
    {
      ...
      "level_name": "第3問",
      "category": "JSBB学童部規定",
      "question": "小学生の高学年の投手板からホームまでの距離として正しいものは（JSBB学童部規定）？",
      "choices": [
        "14m",
        "18.44m",
        "16m"
    ...
    },
    {
      ...
      "level_name": "第3問",
      "category": "JSBB学童部規定",
      "question": "小学生の低学年の塁間が短い大会がある理由は（JSBB学童部規定）？",
      "choices": [
        "走力や送球力に合わせるため",
        "塁を少なくするため",
        "打順を早く回すため"
    ...
    },
    {
      ...
      "main_category": "ルール",
      "middle_category": "打撃ルール",
      "small_category": "バッターボックス外",
      "question": "打者がバッターボックス外で投球を打った時の基本は？",
      "choices": [
        "反則打球になる",
        "本塁打になる",
        "ボールになる"
      ...
      "answer": 0,
      "explanation": "打者が打席外で投球を打つと反則打球になることがあります。",
      "source_note": "v43候補。v42整理版を基準に新規追加候補として別リスト化。",
      "overlap_check": "v42整理版の問題文と完全一致なし。全カテゴリー監査前提の候補。",
      "quality_note": "確認型問題・大会運営問題・二重正解化しやすい表現を避けて作成。"
    },
    ...
    },
    {
      ...
      "quality_note": "v39: 第10問の高難度ルールとして追加。"
    },
    {
      "id": "BQ2091",
      "level": 10,
      ...
      "question": "打順誤りで正しい打者がまだ打席中ならどうなる？",
      "choices": [
        "正しい打者が打席を引き継ぐ",
        "攻撃側が即アウト",
        "試合終了になる"
      ...
      "answer": 0,
      "explanation": "打席中に気づいた場合は正しい打者がカウントを引き継ぎます。",
      "source_note": "v43候補。v42整理版を基準に新規追加候補として別リスト化。",
      "overlap_check": "v42整理版の問題文と完全一致なし。全カテゴリー監査前提の候補。",
      "quality_note": "確認型問題・大会運営問題・二重正解化しやすい表現を避けて作成。"
    },
