window.QUIZ_MASTER_QUESTIONS = {
  "meta": {
    ...
    "validation_errors": [],
    "base_file": "quiz_master_questions_final_candidate_v30_step9.json",
  ...
  "questions": [
    ...
    },
    {
      ...
      "main_category": "野球用語",
      "middle_category": "試合で使う用語",
      "small_category": "ファールチップ",
      "question": "ファールチップとは？",
      "choices": [
        "打球がバットに当たり、そのまま捕手が捕球すること",
        "ファウル地域に落ちたゴロ",
        "打者がバットを投げてしまうこと"
      ],
      "answer": 0,
    ...
    },
    {
      ...
      "answer": 0,
      "explanation": "捕逸はパスボールの日本語表記です。捕手が普通に捕れる投球をそらした時に使います。",
      "source_note": "学童野球の試合・指導で使われる基本用語",
      "overlap_check": "個別用語問題は既存にあるが、同義語関係を問う問題として追加。ワイルドピッチとは原因が違う。",
      "quality_note": "v32: 用語重複を単純削除せず、同じ意味を理解する問題として追加。"
    },
    {
      "id": "BQ603",
    ...
    },
    {
      ...
      "main_category": "野球用語",
      "middle_category": "判定・ルール用語",
      "small_category": "オブストラクション",
      "question": "オブストラクションとは？",
      "choices": [
        "守備側がランナーの進路を妨げること",
        "打者が空振りすること",
        "審判がプレーを止めること"
      ...
      "answer": 0,
      "explanation": "オブストラクションは、守備側がボールを持たずにランナーの走塁を妨げることです。",
      "source_note": "公認野球規則に基づく基本用語",
      "overlap_check": "大分類→中分類→小分類→既存問題検索後に追加。オブストラクションの意味問題は既存なし。",
      "quality_note": "v36: 第9問の高学年用語として追加。"
    },
    {
      "id": "BQ1115",
